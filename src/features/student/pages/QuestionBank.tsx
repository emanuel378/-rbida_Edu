...
import { Search, X, HelpCircle, BookOpen, ArrowRight } from 'lucide-react'
  ...
  return (
    <div className="p-6 lg:p-8 max-w-6xl">
      ...
      <p className="text-sm text-gray-500 mb-4">
        Foram encontradas <strong className="text-gray-800">{filteredQuestions.length}</strong> {filteredQuestions.length === 1 ? 'questão' : 'questões'}
      </p>
      ...
      {filteredQuestions.length === 0 ? (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
          ...
          <p className="text-gray-400 text-sm mt-1">Tente ajustar os filtros para encontrar questões.</p>
        </div>
      ) : (
